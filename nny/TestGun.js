(function() {
    ...
    Pistol = function() {
        ...
        this.fireSound = SoundCache.getSound(Script.resolvePath('40_smith_wesson_single-mike-koenig.wav'));        
        ...
        createGunFireEffect: function(position) {
            var flash = Entities.addEntity({
                ...
                "additiveBlending": true,
				 "textures":"https://github.com/krougeau/HF-Stuff/raw/master/nny/cloud.png"
            });
